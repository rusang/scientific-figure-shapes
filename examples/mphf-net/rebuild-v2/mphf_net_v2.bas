...
Public Sub BuildFinal()
    ...
    Set shp = AddFigureLine(sld, 470.000, 175.000, 493.750, 175.000, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion1_addp5_1")
    Set shp = AddFigureLine(sld, 493.750, 175.000, 493.750, 113.750, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion1_addp5_2")
    Set shp = AddFigureLine(sld, 493.750, 113.750, 549.375, 113.750, RGB(120, 126, 140), 1.000, true, false, true, "FIG_L_fusion1_addp5_3")
    Set shp = AddFigureLine(sld, 441.250, 184.375, 441.250, 215.000, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion1_up2_1")
    Set shp = AddFigureLine(sld, 441.250, 215.000, 385.000, 215.000, RGB(120, 126, 140), 1.000, true, false, true, "FIG_L_fusion1_up2_2")
    Set shp = AddFigureLine(sld, 470.000, 262.500, 493.750, 262.500, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion2_addp4_1")
    Set shp = AddFigureLine(sld, 493.750, 262.500, 493.750, 213.750, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion2_addp4_2")
    Set shp = AddFigureLine(sld, 493.750, 213.750, 549.375, 213.750, RGB(120, 126, 140), 1.000, true, false, true, "FIG_L_fusion2_addp4_3")
    Set shp = AddFigureLine(sld, 441.250, 271.875, 441.250, 292.500, RGB(120, 126, 140), 1.000, true, false, false, "FIG_L_fusion2_addp3_1")
    Set shp = AddFigureLine(sld, 441.250, 292.500, 549.375, 292.500, RGB(120, 126, 140), 1.000, true, false, true, "FIG_L_fusion2_addp3_2")
    ...
    Set shp = AddFigureLine(sld, 705.000, 216.875, 709.375, 216.875, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_head_dec_link1")
    Set shp = AddFigureLine(sld, 718.125, 216.875, 722.500, 216.875, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_head_dec_link2")
    Set shp = AddFigureLine(sld, 731.250, 216.875, 735.625, 216.875, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_head_dec_link3")
    Set shp = AddFigureLine(sld, 744.375, 216.875, 748.750, 216.875, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_head_dec_link4")
    Set shp = AddFigureLine(sld, 757.500, 216.875, 761.875, 216.875, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_head_dec_link5")
    ...
    Set shp = AddFigureLine(sld, 75.000, 407.500, 33.750, 421.250, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_out0")
    Set shp = AddFigureLine(sld, 33.750, 437.500, 75.000, 447.500, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_in0")
    Set shp = AddFigureLine(sld, 75.000, 407.500, 75.000, 421.250, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_out1")
    Set shp = AddFigureLine(sld, 75.000, 437.500, 75.000, 447.500, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_in1")
    Set shp = AddFigureLine(sld, 75.000, 407.500, 116.250, 421.250, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_out2")
    Set shp = AddFigureLine(sld, 116.250, 437.500, 75.000, 447.500, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m1_fan_in2")
    ...
    Set shp = AddFigureLine(sld, 631.250, 400.000, 653.750, 400.000, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m3_in_high")
    Set shp = AddFigureLine(sld, 631.250, 452.500, 653.750, 452.500, RGB(40, 44, 60), 1.000, false, false, true, "FIG_L_m3_in_low")
    ...
    Set shp = AddFigureLine(sld, 375.000, 581.250, 380.625, 581.250, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_b2_dec_link1")
    Set shp = AddFigureLine(sld, 390.625, 581.250, 396.250, 581.250, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_b2_dec_link2")
    Set shp = AddFigureLine(sld, 406.250, 581.250, 411.875, 581.250, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_b2_dec_link3")
    Set shp = AddFigureLine(sld, 421.875, 581.250, 427.500, 581.250, RGB(40, 44, 60), 0.900, false, false, false, "FIG_L_b2_dec_link4")
    ...
    shp.Name = "FIG_G_flow"
    Set shp = sld.Shapes.Range(Array("FIG_T_m1_title", "FIG_T_m1_in", "FIG_E_m1_csp", "FIG_T_m1_csp", "FIG_E_m1_b0", "FIG_T_m1_b0", "FIG_E_m1_b1", "FIG_T_m1_b1", "FIG_E_m1_b2", "FIG_T_m1_b2", "FIG_T_m1_bdots", "FIG_E_m1_fuse", "FIG_T_m1_fuse", "FIG_E_m1_ema", "FIG_T_m1_ema", "FIG_T_m1_out", "FIG_L_m1_f1", "FIG_L_m1_fan_out0", "FIG_L_m1_fan_in0", "FIG_L_m1_fan_out1", "FIG_L_m1_fan_in1", "FIG_L_m1_fan_out2", "FIG_L_m1_fan_in2", "FIG_L_m1_f4", "FIG_L_m1_f5", "FIG_T_m1_p0", "FIG_T_m1_p1", "FIG_T_m1_p2")).Group
    shp.Name = "FIG_G_m1"
    ...
    shp.Name = "FIG_G_m2"
    Set shp = sld.Shapes.Range(Array("FIG_T_m3_title", "FIG_T_m3_fh", "FIG_G_m3_fh_bg", "FIG_G_m3_fh_v1", "FIG_G_m3_fh_v2", "FIG_G_m3_fh_v3", "FIG_G_m3_fh_h1", "FIG_G_m3_fh_h2", "FIG_E_m3_high", "FIG_T_m3_high", "FIG_T_m3_fl", "FIG_G_m3_fl_bg", "FIG_G_m3_fl_v1", "FIG_G_m3_fl_v2", "FIG_G_m3_fl_v3", "FIG_G_m3_fl_h1", "FIG_G_m3_fl_h2", "FIG_E_m3_low", "FIG_T_m3_low", "FIG_E_m3_add", "FIG_E_m3_add_text", "FIG_G_m3_out_bg", "FIG_G_m3_out_v1", "FIG_G_m3_out_v2", "FIG_G_m3_out_h1", "FIG_T_m3_out", "FIG_L_m3_in_high", "FIG_L_m3_in_low", "FIG_L_m3_f1_1", "FIG_L_m3_f1_2", "FIG_L_m3_f2", "FIG_L_m3_f3", "FIG_T_m3_p0", "FIG_T_m3_p1", "FIG_T_m3_p2", "FIG_T_m3_p3")).Group
    shp.Name = "FIG_G_m3"
    Set shp = sld.Shapes.Range(Array("FIG_T_b1_title", "FIG_E_out_p3_top", "FIG_E_out_p3_front", "FIG_E_out_p3_right", "FIG_E_out_p3_label", "FIG_E_out_p4_top", "FIG_E_out_p4_front", "FIG_E_out_p4_right", "FIG_E_out_p4_label", "FIG_E_out_p5_top", "FIG_E_out_p5_front", "FIG_E_out_p5_right", "FIG_E_out_p5_label", "FIG_T_b2_title", "FIG_T_b2_iou", "FIG_E_b2_sq1_0", "FIG_E_b2_sq1_1", "FIG_E_b2_sq1_2", "FIG_E_b2_sq1_3", "FIG_E_b2_sq1_4", "FIG_E_b2_sq1_5", "FIG_E_b2_sq1_dots", "FIG_T_b2_dec", "FIG_E_b2_sq2_0", "FIG_E_b2_sq2_1", "FIG_E_b2_sq2_2", "FIG_E_b2_sq2_3", "FIG_E_b2_sq2_4", "FIG_E_b2_sq2_dots", "FIG_L_b2_dec_link1", "FIG_L_b2_dec_link2", "FIG_L_b2_dec_link3", "FIG_L_b2_dec_link4", "FIG_E_b2_last", "FIG_L_b2_flow", "FIG_L_b1_b2", "FIG_L_b2_b3", "FIG_T_b3_title", "FIG_E_b3_bars_0", "FIG_E_b3_bars_1", "FIG_E_b3_bars_2", "FIG_E_b3_bars_3", "FIG_E_b3_bars_axis", "FIG_T_b3_bars", "FIG_E_b3_box1", "FIG_E_b3_box2", "FIG_T_b3_box", "FIG_T_b4_title", "FIG_E_b4_icon0", "FIG_T_b4_head0", "FIG_T_b4_tail0", "FIG_E_b4_icon1", "FIG_T_b4_head1", "FIG_T_b4_tail1", "FIG_E_b4_icon2", "FIG_T_b4_head2", "FIG_T_b4_tail2")).Group
